...
from live_trading.ZX_connect_live import send_request_02

BASE_URL     = "https://api.bitget.com"
PRODUCT_TYPE = "USDT-FUTURES"  

def close_all_positions():
    code, resp = send_request_02(
        "GET",
    ...
    for pos in positions:
        ...
        close_code, close_resp = send_request_02("POST", "/api/v2/mix/order/close-positions", body=body)
