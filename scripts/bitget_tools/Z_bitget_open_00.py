...
from live_trading.ZX_connect_live import get_open_positions_E1, make_get_E1
from utils.ZZ_connect import connect_bitget_E1
...
if __name__ == "__main__":
    try:       
        # --- OPEN POSITIONS ---
        open_positions = get_open_positions_E1(product_type="USDT-FUTURES")
        print(f"\n00_{STRATEGY}")
    ...
    try:
        ...
        print(f"{'💵' if delta_capital >= 0 else '⭕'} Delta (gain/loss): {delta_capital:+.2f} USDT")
