...
from ZZX_DRAFT5 import parity_long
from ZZX_DRAFT5 import parity_short
...
# -----------------------------------------------------------------------------
# ⭐ CONFIGURACIÓN DE RÉGIMEN DE MERCADO BTC ⭐
# -----------------------------------------------------------------------------
USE_BTC_REGIME      = True       # Activar/desactivar filtro de régimen BTC
REGIME_MODE         = 'simple' # 'simple' o 'advanced'
MIN_REGIME_SCORE    = 1          # Score mínimo para 'advanced' (0-4)
...
def process_combo(comb):
    ...
    for sym in ohlcv_arr_minor.keys():
        ...
        signals = parity_long(
            ...
            live_trading=False,
            ohlcv_data_minor=ohlcv_data_minor,      # ⭐ AÑADIDO
            use_btc_regime=USE_BTC_REGIME,          # ⭐ AÑADIDO
            regime_mode=REGIME_MODE,                # ⭐ AÑADIDO
            min_regime_score=MIN_REGIME_SCORE       # ⭐ AÑADIDO
        )
