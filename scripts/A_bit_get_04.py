...
DOJI_FLAG               = False
HAMMER_FLAG             = True
SHOOTING_STAR_FLAG      = True
BULLISH_ENGULFING_FLAG  = True
BEARISH_ENGULFING_FLAG  = True
PIERCING_LINE_FLAG      = False
DARK_CLOUD_COVER_FLAG   = True
...
def check_latest_signal(df, symbol):
    ...
    pattern_flags = [
        ...
        PIERCING_LINE_FLAG,
        DARK_CLOUD_COVER_FLAG
    ]
    
    df_signal = explosive_signal(df_ind, pattern_flags, live=True)
    
    last_signal = df_signal['signal'].iloc[-1]
