#develop/Z_grid/G_grid_central_TBC.py
import os
import sys
...
from shared.utils.torque import prepare_ohlcv_arrays, compile_grid_results, save_all_trades_to_csv, save_results, save_equity_to_csv
...
SYMBOLS_DIR = os.path.join(os.path.dirname(__file__), "..", "..", "bitget", "BOT_batch", "strategies_E1", "symbols_live")
ORDER_AMOUNT = 80
N_JOBS       = -1
VOL_WINDOW   = 50
...
STRATEGIES = [
    {
        ...
        "bins_to_filter": {'trending_dwtrend', 'ranging_dwtrend', 'volatile_dwtrend'},
        "sell_after":     [50],
        "tp_pct":         [4],
        "sl_pct":         [3],
        "lookback":       [2],
    ...
    },
    {
        ...
        "bins_to_filter": {'trending_uptrend', 'ranging_uptrend', 'volatile_uptrend'},
        "sell_after":     [50],
        "tp_pct":         [4],
        "sl_pct":         [3],
        "lookback":       [3],
...
def make_process_combo(ohlcv_arr, signal_fn, signal_param_keys, grid_param_names,
    ...
    bins_to_filter = strategy_config.get("bins_to_filter", set())
        ...
        for sym, arr in ohlcv_arr.items():
            ...
            if REGIME_FILTER.get('enabled', False):
                signals = filter_signals_by_regime(
                    ...
                    ma_period      = REGIME_FILTER['ma_period'],
                    long_th        = REGIME_FILTER['long_th'],
                    short_th       = REGIME_FILTER['short_th'],
                    families       = FAMILIES,
