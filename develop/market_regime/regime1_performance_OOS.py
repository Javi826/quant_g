...
BASE_DIR      = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "BOT_batch"))
TRADES_FOLDER = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "brief_trades"))
