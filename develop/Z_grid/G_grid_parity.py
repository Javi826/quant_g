...
from utils.st_tools import prepare_ohlcv_arrays, compile_grid_results, save_all_trades_to_csv, save_results
...
save_all_trades_to_csv(grid_results_list, param_names, f"all_trades_{STRATEGY}.xlsx", strategy_name=STRATEGY, save=True)
