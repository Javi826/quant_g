...
# 
# DATA_FOLDER_IS   = os.path.join(SPLIT_BASE, "IS",  "crypto_2022-01_2025-05_IS")
# #DATA_FOLDER_OOS1 = os.path.join(SPLIT_BASE, "OOS", "crypto_2025-05_2026-05_OOS")
# DATA_FOLDER_OOS1 = os.path.join(SPLIT_BASE, "OOS", "crypto_2026-03_2026-06_OOS")
...
DATA_FOLDER_IS   = os.path.join(SPLIT_BASE, "IS",  "crypto_2022-01_2026-02_IS")
DATA_FOLDER_OOS1 = os.path.join(SPLIT_BASE, "OOS", "crypto_2026-02_2026-06_OOS")
CRYPTO_FULL_DIR  = os.path.join(SPLIT_BASE, "IS",  "crypto_full_IS")
