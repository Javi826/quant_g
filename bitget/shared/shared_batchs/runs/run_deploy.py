...
from shared_batchs.engines.wfo_WF import (
    WARMUP_BARS, EMA_ALPHA, _select_window_symbols, _update_ema_state, _round_params_dict,
)
...
# =============================================================================
# PRIVATE HELPERS — "wfo" mode: single present-anchored train-only window
# =============================================================================
...
# =============================================================================
# PRIVATE HELPERS — "wfo_ema" mode: rebuild the full EMA chain anchored to present
# =============================================================================
